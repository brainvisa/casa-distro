...
# Packages that were defined in CATI image but not on casa-dev
# This image was fusioned with casa-dev in the Python3-Qt5 image
DEBIAN_FRONTEND=noninteractive $SUDO apt-get install -y firefox
DEBIAN_FRONTEND=noninteractive $SUDO apt-get install -y libasound2-dev
DEBIAN_FRONTEND=noninteractive $SUDO apt-get install -y libavahi-compat-libdnssd-dev
DEBIAN_FRONTEND=noninteractive $SUDO apt-get install -y libcurl4-openssl-dev
DEBIAN_FRONTEND=noninteractive $SUDO apt-get install -y dcmtk
DEBIAN_FRONTEND=noninteractive $SUDO apt-get install -y libgdcm-tools
DEBIAN_FRONTEND=noninteractive $SUDO apt-get install -y libopenblas-dev
DEBIAN_FRONTEND=noninteractive $SUDO apt-get install -y libopenslide-dev
DEBIAN_FRONTEND=noninteractive $SUDO apt-get install -y libssl-dev
DEBIAN_FRONTEND=noninteractive $SUDO apt-get install -y mriconvert
DEBIAN_FRONTEND=noninteractive $SUDO apt-get install -y mricron
DEBIAN_FRONTEND=noninteractive $SUDO apt-get install -y nautilus
DEBIAN_FRONTEND=noninteractive $SUDO apt-get install -y poppler-utils
DEBIAN_FRONTEND=noninteractive $SUDO apt-get install -y python3-poppler-qt5
DEBIAN_FRONTEND=noninteractive $SUDO apt-get install -y python3-six
DEBIAN_FRONTEND=noninteractive $SUDO apt-get install -y python3-xlrd
DEBIAN_FRONTEND=noninteractive $SUDO apt-get install -y python3-xlsxwriter
DEBIAN_FRONTEND=noninteractive $SUDO apt-get install -y xalan
